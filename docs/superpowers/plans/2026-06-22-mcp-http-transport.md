...
```bash
docker compose -f docker-compose.dev.yml exec -T -e GEO_TEST_DATABASE_URL=mysql+pymysql://geo_user:geo_password@mysql:3306/geo_test app pytest server/tests/test_mcp_http_client.py::test_mcp_config_internal_api_url_defaults_to_localhost server/tests/test_mcp_http_client.py::test_mcp_config_internal_api_url_respects_env -q
```
...
```bash
docker compose -f docker-compose.dev.yml exec -T -e GEO_TEST_DATABASE_URL=mysql+pymysql://geo_user:geo_password@mysql:3306/geo_test app pytest server/tests/test_mcp_http_client.py -q
```
...
```bash
docker compose -f docker-compose.dev.yml exec -T -e GEO_TEST_DATABASE_URL=mysql+pymysql://geo_user:geo_password@mysql:3306/geo_test app pytest server/tests/test_mcp_catalog.py server/tests/test_mcp_http_client.py -q
```
...
```bash
docker compose -f docker-compose.dev.yml exec -T -e GEO_TEST_DATABASE_URL=mysql+pymysql://geo_user:geo_password@mysql:3306/geo_test app pytest server/tests/test_mcp_auth.py -q -k verify_mcp_token
```
...
```bash
docker compose -f docker-compose.dev.yml exec -T -e GEO_TEST_DATABASE_URL=mysql+pymysql://geo_user:geo_password@mysql:3306/geo_test app pytest server/tests/test_mcp_auth.py server/tests/test_mcp_catalog.py server/tests/test_mcp_connect.py -q
```
...
```bash
docker compose -f docker-compose.dev.yml exec -T -e GEO_TEST_DATABASE_URL=mysql+pymysql://geo_user:geo_password@mysql:3306/geo_test app pytest server/tests/test_mcp_http_mount.py -q
```
...
```bash
docker compose -f docker-compose.dev.yml exec -T -e GEO_TEST_DATABASE_URL=mysql+pymysql://geo_user:geo_password@mysql:3306/geo_test app pytest server/tests/test_mcp_entry.py server/tests/test_mcp_catalog.py -q
```
...
```bash
docker compose -f docker-compose.dev.yml exec -T -e GEO_TEST_DATABASE_URL=mysql+pymysql://geo_user:geo_password@mysql:3306/geo_test app pytest server/tests/test_mcp_http_mount.py::test_mcp_endpoint_mounted_with_auth -q
```
...
```bash
docker compose -f docker-compose.dev.yml exec -T -e GEO_TEST_DATABASE_URL=mysql+pymysql://geo_user:geo_password@mysql:3306/geo_test app pytest server/tests/ -q -k mcp
...
```bash
docker compose -f docker-compose.dev.yml exec -T -e GEO_TEST_DATABASE_URL=mysql+pymysql://geo_user:geo_password@mysql:3306/geo_test app pytest server/tests/ -q
```
